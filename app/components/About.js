...
export default function About() {
  return (
    <section className='h-[200vh] w-[100vw] flex flex-col justify-center items-center  md:mb-0 mb-80' id='aboutus'>
      <div className=' md:text-5xl text-3xl font-semibold text-center my-10'>About Us</div>
      <div className='h-[60vh] w-full max-w-[1500px] flex md:flex-row flex-col justify-between items-center '>
      ...
      <div className='h-[60vh] w-full max-w-[1500px] flex flex-col-reverse md:flex-row  justify-between items-center md:pt-0 pt-[32vh]'>
        <div className='md:w-3/5 w-full h-[80%] flex justify-evenly flex-col px-12 items-center'>
      ...
      <div className='h-[60vh] w-full max-w-[1500px] flex md:flex-row flex-col justify-between items-center md:pt-0 pt-[12vh]'>
        <div className='md:w-2/5 w-[95vw] h-full  flex justify-center items-center '>
