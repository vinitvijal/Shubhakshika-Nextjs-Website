    ...
    <section className='h-[100vh] w-[100vw] bg-slate-100 flex justify-center items-center flex-col'>
        ...
        <div className=' h-[60vh] w-[90vw] flex md:flex-row flex-col justify-evenly items-center'>
            <div className='w-1/3 relative md:mt-0 mt-14'>
                <div className='border absolute top-10 border-black md:h-[50vh] md:w-[50vh] h-32 w-full -left-10'></div>
                <Image src={usha} alt='mam' className='md:h-[50vh] md:w-[50vh] h-32 w-full relative'/>
            </div>
            <div className='md:w-1/2 md:text-left text-left md:mt-0 mt-20'>
