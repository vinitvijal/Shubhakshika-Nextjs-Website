...
function OurProjects() {
  return (
    <div className='min-h-[120vh] w-[100vw]  bg-zinc-300/70  flex justify-center items-center flex-col' id='projects'>
        <p className=' md:text-6xl text-4xl flex items-center justify-center font-bold h-[20vh]'>Our Projects</p>
        <div className=' min-h-[80vh] md:px-20 px-5 md:grid-cols-3 grid-cols-1 grid w-full gap-5 pb-10'>
                <Card className='md:w-[30vw] w-full p-5 gap-5 mx-auto flex flex-col items-center'>
                    <Image src={project3} alt="Picture of the author" width={500} height={500} className="h-2/5 object-cover  rounded-lg" />
                ...
                <Card className='md:w-[30vw] w-full p-5 gap-5 mx-auto flex flex-col items-center'>
                    <Image src={vocational} alt="Picture of the author" width={500} height={500} className=" h-2/5 object-cover rounded-lg" />
                ...
                <Card className='md:w-[30vw] w-full p-5 gap-5 mx-auto flex flex-col items-center'>
                    <Image src={girleducation} alt="Picture of the author" width={500} height={500} className=" h-2/5 object-cover rounded-lg" />
                ...
                <Card className='md:w-[30vw] w-full p-5 gap-5 mx-auto flex flex-col items-center'>
                    <Image src={education} alt="Picture of the author" width={500} height={500} className=" h-2/5 object-cover rounded-lg" />
                ...
                <Card className='md:w-[30vw] w-full p-5 gap-5 mx-auto flex flex-col items-center'>
                    <Image src={deaddiction} alt="Picture of the author" width={500} height={500} className="h-2/5 object-cover  rounded-lg" />
